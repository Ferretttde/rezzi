...
function RecipeListPage() {
  ...
  return (
    <div className="min-h-dvh">
      <PageHeader
        title="Rezzi"
        subtitle={recipes ? `${recipes.length} recipes` : undefined}
      />
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-muted-foreground text-sm mt-1 max-w-xs">
              {hasFilters
                ...
                : 'Add your first recipe by tapping the + button below'}
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-2 gap-3">
      ...
      <BottomSheet open={fabOpen} onOpenChange={setFabOpen}>
        ...
        <BottomSheetContent>
          <h3 className="text-lg font-semibold mb-4">Add a Recipe</h3>
          <div className="space-y-3">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Fill in the recipe form</p>
              </div>
            </button>
            <button
              onClick={() => {
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Paste a link from any recipe site</p>
              </div>
            </button>
          </div>
        </BottomSheetContent>
